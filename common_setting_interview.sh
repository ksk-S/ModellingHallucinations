...
declare -a original_init_files=("junco.jpg" "bolete.jpg"  "lightshade.jpg" "volcano.jpg" "ladybug.jpg")
...
# Target categories
declare -a original_image_units=( 13 997 846 980 301 )
declare -a shifted_image_units=(301 13 997 846 980  )
...
montage_iters="000 005 010 050 100 200 400 600 800 1000"
